...
const core = require('@shop0/commerce/config')

const PROVIDERS = [
  '@shop0/commerce-local',
  '@shop0/commerce-bigcommerce',
  '@shop0/commerce-saleor',
  '@shop0/commerce-shopify',
  '@shop0/commerce-swell',
  '@shop0/commerce-vendure',
  '@shop0/commerce-ordercloud',
  '@shop0/commerce-kibocommerce',
  '@shop0/commerce-spree',
  '@shop0/commerce-commercejs',
  '@shop0/commerce-sfcc',
]
