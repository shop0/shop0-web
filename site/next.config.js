...
const isBC = provider === '@shop0/commerce-bigcommerce'
const isShopify = provider === '@shop0/commerce-shopify'
const isSaleor = provider === '@shop0/commerce-saleor'
const isSwell = provider === '@shop0/commerce-swell'
const isVendure = provider === '@shop0/commerce-vendure'
